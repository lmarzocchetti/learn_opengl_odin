...
main :: proc() {
	...
	shader_source := load_shader_source("1_0_uniform/shaders/shader.vert")
	...
	shader_source = load_shader_source("1_0_uniform/shaders/shader.frag")
	...
	if vertex_color_location < 0 {
		log.fatalf("Could not find uniform location 'ourColor'")
	}
	...
	for !glfw.WindowShouldClose(window) {
		...
		// gl.BindVertexArray(0)
		green_value: f32 = cast(f32)(math.sin(time_value) / 2.0) + 0.5
